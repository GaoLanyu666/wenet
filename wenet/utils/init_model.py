...
from wenet.transformer.encoder import TransformerEncoder, ConformerEncoder, SpikeformerEncoder, SpikeConformerEncoder, SpikeTConformerEncoder, SpikeConformerLengthEncoder, SpikeConformerAudioLengthEncoder
from wenet.transformer.decoder import BiTransformerDecoder, TransformerDecoder, SpikeformerDecoder, SpikeTransformerDecoder
...
WENET_ENCODER_CLASSES = {
    ...
    "spikeformer": SpikeformerEncoder,
    "spikeconformer": SpikeConformerEncoder,
    "spiketconformer": SpikeTConformerEncoder,
    "spikeconformerlength": SpikeConformerLengthEncoder,
    "spikeconformeraudiolength": SpikeConformerAudioLengthEncoder,
...
WENET_DECODER_CLASSES = {
    ...
    "spikeformer": SpikeformerDecoder,
    "spiketransformer": SpikeTransformerDecoder,
