...
class SpikeDecoderLayer(nn.Module):
    """Single decoder layer module.
...
class SpikeTransformerDecoderLayer(nn.Module):
    """Single decoder layer module.
    ...
    def forward(
        ...
        # print("tgt_q.shape:", tgt_q.shape)
        # print("tgt_q_mask.shape:", tgt_q_mask.shape)
