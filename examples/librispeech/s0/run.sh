...
datadir=/public/home/wangmiao/dataset/en-asr-data/OpenSLR
# wav data dir
wave_data=data
data_type=raw
# Optional train_config
# 1. conf/train_transformer_large.yaml: Standard transformer
train_config=conf/train_spikeconformer_relSSALN.yaml
checkpoint=/public/home/wangmiao/gly/code/wenet/examples/librispeech/s0/exp/spikeconformer_relSSALN_grad1_sp_spec_aug/epoch_9.pt
num_workers=1
do_delta=false

dir=exp/spikeconformer_relSSALN_grad1_sp_spec_aug
