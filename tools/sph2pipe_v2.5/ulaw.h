 ...
 * ulaw.h
 *------------------------------------------------------------
 * contains a lookup table (generated by a function that is
 * documented in shorten_x.c) to convert a ulaw byte value
 * to the corresponding 16-bit linear pcm value.
 */
